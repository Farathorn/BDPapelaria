...
public class Funcionario implements EntidadeForte{
	...
	public static String descriptor = "Funcion�rio";
	...
	public String[] listAttributes () {
		...
		String[] lista = {"CPF", "Nome", "Carteira_de_Trabalho", "Cargo", "Expediente", "Sal�rio_Base", "Faltas", "Venda_do_M�s", "Ticket_M�dio", "Franquia"};
